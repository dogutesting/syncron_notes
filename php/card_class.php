...
class card_class {
    ...
    public function __construct($id, $head, $body, $creation_date, $last_sync_date) {
        $this->id = $id;
        $this->head = $head;
        $this->body = $body;
    ...
    public function getCardDiv() {
        return '<div class="card" data-id="'.$this->id.'" data-creation="'.$this->creation_date.'" data-update="'.$this->last_sync_date.'">
